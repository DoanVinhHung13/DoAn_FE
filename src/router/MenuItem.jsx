...
export const farmManagerItem = () => [
  ...
  },
  {
    ...
    children: [
      {
        key: ROUTER.FM_FERTILIZERS,
        icon: <FertilizerIcon style={{ fontSize: "16px" }} />,
        label: "Phân bón",
      },
      {
        key: ROUTER.FM_PESTICIDES,
        icon: <PesticideIcon style={{ fontSize: "16px" }} />,
        label: "Nông dược",
      },
      {
        key: ROUTER.FM_INVENTORY_IMPORT_HISTORY,
        icon: <ImportHistoryIcon style={{ fontSize: "16px" }} />,
        label: "Lịch sử nhập kho",
      },
      {
        key: ROUTER.FM_MATERIAL_USAGE_HISTORY,
        icon: <ImportHistoryIcon style={{ fontSize: "16px" }} />,
        label: "Lịch sử sử dụng vật tư",
      },
    ],
  },
  {
    ...
    children: [
      {
        key: ROUTER.FM_REF_FERTILIZER,
        icon: <ReferenceBookIcon style={{ fontSize: "16px" }} />,
        label: "Danh mục phân bón",
      },
      {
        key: ROUTER.FM_REF_PESTICIDE,
        icon: <ReferenceBookIcon style={{ fontSize: "16px" }} />,
        label: "Danh mục nông dược",
      },
    ],
  },
]
...
export const getMenuByRole = role => {
  switch (role) {
    case ROLES.FARM_MANAGER:
      return farmManagerItem()
    case ROLES.FARM_SUPERVISOR:
      return farmSupervisorItem()
    case ROLES.FARMER_LEADER:
      return farmLeaderItem()
    default:
      return []
  }
}
