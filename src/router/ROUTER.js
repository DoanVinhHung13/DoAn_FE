...
const ROUTER = {
  ...
  FM_TASKS: '/farm-manager/standard-tasks',
  FM_TASK_CREATE: '/farm-manager/standard-tasks/create',
  FM_TASK_DETAIL: '/farm-manager/standard-tasks/:id',
  FM_TASK_EDIT: '/farm-manager/standard-tasks/:id/edit',
  FM_BATCHES: '/farm-manager/batches',
  FM_BATCH_CREATE: '/farm-manager/batches/create',
  FM_BATCH_DETAIL: '/farm-manager/batches/:id',
  FM_BATCH_EDIT: '/farm-manager/batches/:id/edit',
  ...
  FM_VIEW_EQUIPMENT_MACHINERY: '/farm-manager/view-equipment-machinery',
  FM_VIEW_EQUIPMENT_CREATE: '/farm-manager/view-equipment-machinery/create',
  FM_VIEW_EQUIPMENT_DETAIL: '/farm-manager/view-equipment-machinery/:id',
  FM_VIEW_EQUIPMENT_EDIT: '/farm-manager/view-equipment-machinery/:id/edit',
  FM_VIEW_FARM_SUPPLIES: '/farm-manager/view-farm-supplies',
  FM_VIEW_FARM_SUPPLY_CREATE: '/farm-manager/view-farm-supplies/create',
  FM_VIEW_FARM_SUPPLY_DETAIL: '/farm-manager/view-farm-supplies/:id',
  FM_VIEW_FARM_SUPPLY_EDIT: '/farm-manager/view-farm-supplies/:id/edit',
