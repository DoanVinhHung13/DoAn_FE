...
export const getHarvestBatches = (params, config = {}) => http.get(apiGetBatches, { params, ...config });
export const getHarvestBatchById = (id, config = {}) => http.get(apiGetBatchById(id), config);
export const getHarvestBatchTraceability = (id, config = {}) => http.get(apiGetBatchTraceability(id), { skipNotice: true, skipAuthRedirect: true, ...config });
export const createHarvestBatch = (data) => http.post(apiCreateBatch, data);
export const updateHarvestBatch = (id, data) => http.put(apiUpdateBatch(id), data);
