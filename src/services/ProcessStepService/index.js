...
const getById = id => http.get(apiGetProcessStepById(id), silentConfig)

const create = body => http.post(apiCreateProcessStep, body, silentConfig)

const update = (id, body) =>
  http.put(apiUpdateProcessStep(id), body, silentConfig)

const remove = id => http.delete(apiDeleteProcessStep(id), silentConfig)
