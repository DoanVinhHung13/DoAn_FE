...
// Workflow endpoints
export const apiSubmitCompletion = id =>
  `/cultivation-logbooks/${id}/submit-completion`
export const apiApproveCompletion = id =>
  `/cultivation-logbooks/${id}/approve-completion`
export const apiRejectCompletion = id =>
  `/cultivation-logbooks/${id}/reject-completion`
