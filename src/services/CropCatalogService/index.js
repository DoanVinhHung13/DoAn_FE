...
const getCropCatalogById = (id, config) =>
  http.get(apiGetCropCatalogById(id), config)
const createCropCatalog = (body, config) =>
  http.post(apiCreateCropCatalog, body, config)
const updateCropCatalog = (id, body, config) =>
  http.put(apiUpdateCropCatalog(id), body, config)
