...
export const apiGetMaterialRemainingArea = (taskId, materialId) =>
  `/cultivation-daily-logs/task/${taskId}/materials/${materialId}/remaining-area`
export const apiGetDailyLogsByStage = stageId =>
  `/cultivation-daily-logs/stage/${stageId}`
export const apiGetDailyLogTaskSummary = taskId =>
  `/cultivation-daily-logs/task/${taskId}/summary`
export const apiGetMaterialRecommendations =
  "/cultivation-daily-logs/recommendations"
