export const UI = {
  page: {
    wrapper: 'admin-compact-list space-y-6 duration-500 animate-in fade-in slide-in-from-bottom-4',
  ...
  btn: {
    ...
    iconEdit: 'flex items-center justify-center w-8 h-8 rounded-lg hover:bg-green-50',
    iconDelete: 'flex items-center justify-center w-8 h-8 rounded-lg hover:bg-red-50',
    iconActivate: 'flex items-center justify-center w-8 h-8 rounded-lg hover:bg-green-50',
