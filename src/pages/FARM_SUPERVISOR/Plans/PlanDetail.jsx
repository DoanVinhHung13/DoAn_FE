...
const normalizeTabKey = value => {
  ...
  if (value === "3" || value === "finalization" || value === "closing")
    return "3"
  return "1"
}
  ...
  if (loadError) {
    return (
      <div className="space-y-4">
        ...
        />
        <Button onClick={() => navigate(ROUTER.FS_CULTIVATION_LOGBOOKS)}>
          Quay lại
        </Button>
      </div>
    )
  ...
  if (!plan) {
    return (
      <div className="py-16 text-center">
        ...
        <Button
          onClick={() => navigate(ROUTER.FS_CULTIVATION_LOGBOOKS)}
          className="mt-4"
        >
          Quay lại
        </Button>
    ...
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        ...
        {!isPlanCompleted && (
          <Tooltip
            title={
              !canSubmit ? "Hoàn thành tất cả các giai đoạn trước khi gửi." : ""
            }
          >
            <Button
              type="primary"
      ...
      <Card bordered className="border-gray-200 shadow-sm rounded-2xl">
        ...
        >
          ...
          >
            <Text strong>
              {plan.cropCatalogName || plan.cropCategoryName || "—"}
            </Text>
          </Descriptions.Item>
          <Descriptions.Item
            label={
                    ...
                    >
                      {plot.id ? (
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              ROUTER.FS_LAND_DETAIL.replace(":id", plot.id),
                            )
                          }
        ...
        {plan.reviewStatus === "REJECTED" && plan.rejectionReason && (
          <Alert
            ...
            description={
              <span className="text-red-600 whitespace-pre-line break-words [overflow-wrap:anywhere]">
