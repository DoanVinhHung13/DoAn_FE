...
const stories = [
  {
    ...
    detail: {
      ...
      solution:
        "Áp dụng EAPLS để số hóa quy trình ghi chép. Mỗi nông hộ được cấp tài khoản mobile để cập nhật hoạt động hàng ngày. Cán bộ HTX giám sát thời gian thực qua bảng điều khiển trung tâm.",
      impact:
  ...
  },
  {
    ...
    detail: {
      challenge:
        "Đối tác nước ngoài yêu cầu khắt khe về việc minh bạch quá trình sử dụng phân bón hữu cơ và nông dược sinh học trong suốt chu kỳ sinh trưởng của cây Sachi.",
      solution:
        "Triển khai hệ thống truy xuất nguồn gốc QR code tích hợp với nhật ký canh tác. Toàn bộ dữ liệu được lưu trữ không thể thay đổi trên hệ thống.",
      impact:
  ...
  },
  {
    ...
    detail: {
      ...
      solution:
        "Sử dụng EAPLS để theo dõi chi tiết từ khâu chọn giống, thổ nhưỡng đến khi thu hoạch và vận chuyển về nhà máy chiết xuất.",
      impact:
    ...
    <>
      <section className="relative px-6 py-16 overflow-hidden bg-slate-50 md:py-20">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute w-32 h-32 top-10 left-10 text-green-600 opacity-20">
            QR
          </div>
          <div className="absolute w-32 h-32 bottom-10 right-10 text-blue-600 opacity-20">
            ✓
          </div>
        </div>
