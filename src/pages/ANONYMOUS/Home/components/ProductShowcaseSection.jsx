...
const products = [
  {
    ...
    detail: {
      ...
      timeline: [
        ...
        {
          date: "10/09/2025",
          activity: "Kiểm tra chất lượng",
          note: "Không phát hiện dư lượng nông dược",
        },
        {
          date: "15/10/2025",
    ...
    detail: {
      ...
      timeline: [
        ...
        },
        {
          ...
          note: "Thời tiết thuận lợi",
        },
        {
          date: "20/06/2025",
          activity: "Bao trái",
          note: "Sử dụng túi bao chuyên dụng",
        },
        {
          date: "05/11/2025",
          activity: "Kiểm định chất lượng",
          note: "Đạt chuẩn size và độ đường",
        },
        {
          date: "20/11/2025",
  ...
  },
  {
    ...
    detail: {
      ...
      timeline: [
        ...
        {
          date: "10/04/2025",
          activity: "Kiểm tra độ chín",
          note: "Vít nắp đạt 90%",
        },
        {
          date: "01/05/2025",
          activity: "Khai thác mật",
          note: "Công nghệ quay ly tâm",
        },
        {
          date: "10/05/2025",
          activity: "Lọc và đóng chai",
          note: "Vô trùng tuyệt đối",
        },
      ],
    },
  },
          ...
          <div className="flex flex-col items-end justify-between gap-8 mb-16 md:flex-row scroll-reveal">
            <div className="max-w-2xl space-y-4">
              ...
              <Paragraph className="text-lg text-gray-500">
                ...
                gốc, giúp người tiêu dùng an tâm sử dụng.
              </Paragraph>
            </div>
            <Button
              type="primary"
            ...
            <div className="p-8 space-y-10 md:p-10">
              ...
              <div className="bg-gray-50 p-6 rounded-[32px] border border-gray-100">
                ...
                <Text className="text-[10px] text-gray-400 block mt-4 text-center italic">
                  * Toàn bộ dữ liệu được xác thực và bảo vệ bởi hệ thống EAPLS
                  Blockchain
                </Text>
              </div>
