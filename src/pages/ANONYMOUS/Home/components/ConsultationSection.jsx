    ...
    try {
      ...
      if (response?.success) {
        if (response.data?.aiResponse) {
          message.success({
            content:
              "Gửi yêu cầu thành công! Vui lòng kiểm tra email để xem gợi ý sơ bộ từ AI EAPLS.",
            duration: 5,
          })
              ...
              <div className="p-4 mt-4 border border-blue-100 bg-blue-50 rounded-xl">
                ...
                <div className="border-t border-blue-100 pt-3 mt-3">
                  <Text type="secondary" className="text-xs">
                    * Đây là phản hồi tự động. Chuyên gia của chúng tôi sẽ liên
                    hệ trực tiếp trong 24h.
                  </Text>
                </div>
              </div>
            ),
          ...
          <Col xs={24} md={12}>
            <div className="space-y-6 scroll-reveal">
              <div className="flex items-center gap-3">
                ...
                <span className="px-4 py-1 text-xs font-black tracking-widest uppercase bg-green-50 text-green-600 rounded-full">
                  Liên hệ
                </span>
              </div>
              <Title
