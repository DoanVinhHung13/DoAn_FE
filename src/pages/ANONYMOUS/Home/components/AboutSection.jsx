      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mb-16 text-center scroll-reveal">
          ...
          <Paragraph className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-400">
            ...
            chuyên gia giàu kinh nghiệm hoạt động ở nhiều lĩnh vực Kinh tế - Xã
            hội khác nhau.
          </Paragraph>
        </div>
          ...
          <Col xs={24} md={12}>
            <div className="h-full p-8 transition-all border bg-white/5 backdrop-blur-sm border-white/10 rounded-3xl hover:bg-white/10 hover-lift scroll-reveal">
              ...
              <Paragraph className="text-gray-300 text-base leading-relaxed !mb-0">
                ...
                đơn giản và hiệu quả. Mang lại những sản phẩm và dịch vụ có giá
                trị thực tế, giúp gia tăng hiệu quả hoạt động, phát triển bền
                vững và thịnh vượng cho các tổ chức và doanh nghiệp.
              </Paragraph>
            </div>
          </Col>
          ...
          <Col xs={24} md={12}>
            <div className="h-full p-8 transition-all border bg-white/5 backdrop-blur-sm border-white/10 rounded-3xl hover:bg-white/10 hover-lift scroll-reveal">
              ...
              <Paragraph className="text-gray-300 text-base leading-relaxed !mb-0">
                ...
                Việt Nam. Tập trung vào chất lượng, sáng tạo và sự cam kết, đóng
                góp tích cực vào sự phát triển toàn diện của cộng đồng và xã
                hội.
              </Paragraph>
            </div>
          </Col>
            ...
            {[
              ...
              <Col xs={24} md={8} key={idx}>
                <div className="flex flex-col items-center gap-4 text-center group">
                  ...
                  <Paragraph className="text-gray-300 text-sm leading-relaxed max-w-[280px]">
                    {obj.text}
                  </Paragraph>
                </div>
              </Col>
