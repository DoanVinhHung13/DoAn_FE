  ...
  const handleQrSearch = async values => {
    ...
    try {
      const response = await api.get(
        `/traceability/${encodeURIComponent(qrCode)}`,
        {
          skipNotice: true,
    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          >
            Nhập mã truy xuất hoặc quét mã QR trên tem sản phẩm để xem thông tin
            nguồn gốc.
          </p>
        </div>
          ...
          >
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-1.5">
                ...
                <Text style={{ fontSize: "0.82rem", color: "#616161" }}>
                  {guide.text}
                </Text>
              </div>
            ))}
