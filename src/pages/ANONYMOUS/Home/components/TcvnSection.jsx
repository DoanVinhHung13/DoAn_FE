        ...
        <Row gutter={[48, 48]} align="middle">
                ...
                {tcvnList.map((item, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "14px 20px",
                      borderBottom:
                        i < tcvnList.length - 1 ? "1px solid #f0f0f0" : "none",
                      cursor: "pointer",
                  ...
                  >
                    ...
                    >
                      <SafetyCertificateFilled
                        style={{ color: "#01579b", fontSize: 14 }}
                      />
                    </div>
                    <Text
                      style={{ fontSize: "0.88rem", color: "#424242", flex: 1 }}
                    >
                      {item}
                    </Text>
                    <ArrowRightOutlined
          ...
          <Col xs={24} md={12}>
            <div style={{ paddingLeft: 8 }}>
              ...
              >
                Hệ thống được xây dựng dựa trên danh mục đầy đủ các tiêu chuẩn
                quốc gia về truy xuất nguồn gốc (TCVN). Giúp sản phẩm của bạn dễ
                dàng vượt qua các rào cản kỹ thuật và tiến xa ra thị trường quốc
                tế.
              </Paragraph>
