    ...
    <div className="bg-white min-h-screen font-['Roboto',_sans-serif]">
      <div className="max-w-7xl mx-auto px-6 py-10 animate-in fade-in duration-700">
        ...
        <div className="mb-12">
          <Title
            level={1}
            className="!text-[#242424] !font-black !mb-4 !text-4xl md:!text-5xl tracking-tight"
          >
            Tin tức nổi bật
          </Title>
          <Paragraph className="text-[#505050] text-lg max-w-3xl leading-relaxed">
            Tổng hợp các bài viết chia sẻ về kinh nghiệm sản xuất nông nghiệp
            sạch, ứng dụng công nghệ số và cập nhật biến động thị trường mới
            nhất.
          </Paragraph>
        </div>
            ...
            {isLoading ? (
              ...
              <div className="space-y-12">
                {filteredNews.map((news, index) => (
                  ...
                  >
                    <div className="bg-white rounded-[24px] border-2 border-gray-300 shadow-md p-6 transition-all hover:border-green-600 hover:shadow-lg">
                      {/* Author Header */}
                          ...
                          <Avatar
                            ...
                            src={
                              typeof news.author === "object"
                                ? getAvatarUrl(news.author?.avatar)
                                : null
                            }
                            style={{
                      ...
                      <div className="flex flex-col-reverse md:flex-row gap-8">
                        <div className="flex-1">
                          <Title
                            level={2}
                            className="!text-[#242424] !font-black !mb-3 !text-xl md:!text-2xl group-hover:text-green-600 transition-colors leading-snug tracking-tight"
                          >
                            {news.title}
                          </Title>
              ...
              <div className="py-24 text-center bg-gray-50 rounded-[32px] border border-dashed border-gray-200">
                <Title level={4} className="text-gray-400 font-bold">
                  Chưa có bài viết nào trong chủ đề này
                </Title>
                <Button
                  type="primary"
                  className="bg-[#242424] hover:bg-black border-0 rounded-full mt-6 h-12 px-8 font-bold"
          ...
          <Col xs={24} lg={8} className="hidden lg:block">
            <div className="sticky top-24 space-y-12 pl-6">
              ...
              <div>
                <Title
                  level={5}
                  className="!text-[#757575] !uppercase !text-[11px] !font-black !tracking-widest !mb-6"
                >
                  XEM CÁC TIN TỨC THEO CHỦ ĐỀ
                </Title>
              ...
              <div className="bg-[#1877F2]/10 p-8 rounded-[24px] border border-[#1877F2]/20 group cursor-pointer">
                <Title
                  level={4}
                  className="!text-[#1877F2] !font-black !mb-2 flex items-center gap-2"
                >
                  <FacebookFilled /> Cộng đồng
                </Title>
                <Paragraph className="text-[#1877F2]/80 text-sm mb-6 font-medium">
                  Gia nhập cộng đồng nông nghiệp số EAPLS để cùng trao đổi và
                  học hỏi.
                </Paragraph>
                <Button className="w-full rounded-full font-black border-[#1877F2] text-[#1877F2] hover:bg-[#1877F2] hover:text-white transition-all h-11">
                  THAM GIA NGAY
                </Button>
              </div>
              ...
              <div className="bg-[#FF0000]/5 p-8 rounded-[24px] border border-[#FF0000]/10 group cursor-pointer">
                <Title
                  level={4}
                  className="!text-[#FF0000] !font-black !mb-2 flex items-center gap-2"
                >
                  <YoutubeFilled /> Video hướng dẫn
                </Title>
                <Paragraph className="text-[#FF0000]/70 text-sm mb-6 font-medium">
                  Theo dõi các video hướng dẫn kỹ thuật canh tác VietGAP trên
                  YouTube.
                </Paragraph>
                <Button className="w-full rounded-full font-black border-[#FF0000] text-[#FF0000] hover:bg-[#FF0000] hover:text-white transition-all h-11">
                  XEM YOUTUBE
                </Button>
              </div>
              ...
              <div>
                <Title
                  level={5}
                  className="!text-[#757575] !uppercase !text-[11px] !font-black !tracking-widest !mb-6 flex items-center gap-2"
                >
                ...
                <div className="space-y-6">
                  {newsItems.slice(0, 3).map((news, idx) => (
                    <div
                      key={idx}
                      className="group cursor-pointer border-2 border-gray-300 bg-white shadow-md rounded-xl hover:border-green-600 p-3 transition-all"
                      onClick={() => navigate(`/news/${news._id}`)}
                    >
                      <Title
                        level={5}
                        className="!text-[#242424] !font-bold !text-[14px] group-hover:text-green-600 transition-colors line-clamp-2 leading-snug mb-1"
                      >
                        {news.title}
                      </Title>
                      <Text className="text-gray-400 text-[10px] font-black uppercase">
                        {formatDate(news.publishedAt, "DD MMM, YYYY")}
                      </Text>
                    </div>
                  ))}
                </div>
