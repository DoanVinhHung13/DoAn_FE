...
!(function () {
  ...
  const Cs = (e, t, n, o) =>
    ...
    Ls = (e, t, n) => {
      ...
      q(No(n), t => {
        er(t, s, a).each(n => {
          const o = (t => Y(Hn(t), t => s(t) && !e.isValidChild(xn(n), xn(t))))(
            t,
          )
          if (o.length > 0) {
            const t = Mn(n)
    ...
    kg = (e, t) => {
      ...
      const E = e => C(e) && (is(e) || n.is(e, "figure.image")),
        ...
        _ = e => {
          ...
          ;((e, t) => {
            if (
              (e => "longpress" === e.type || 0 === e.type.indexOf("touch"))(e)
            ) {
              const n = e.touches[0]
                    ...
                    ;(h.stopImmediatePropagation(),
                      ...
                      (h => {
                        ...
                        ;((u = h.screenX),
                          ...
                          (i = ((e, t) => {
                            if (x(t))
                              return e.create("img", { src: nn.transparentSrc })
                            if (Zr(t)) {
        ...
        ((e, t) => {
          ...
          if (t) {
            ...
            an.each(a, e => {
              ...
              if (
                !Lp(o, (l = e)) &&
                !((e, t) => Lp(e, t) && $(Dp(e, t), e => (e => Bp.has(e))(e)))(
                  o,
                  l,
                ) &&
                a(e) &&
        ...
        f = (o, a, i) => {
          ...
          ;(Hf(o, a, a => {
            ...
            const p = a => {
              ...
              if (
                (o => (e => wf(e) && !0 === e.wrapper)(s) && iv(e, o, t, n))(a)
              )
                u = null
              else {
                if (
  ...
  const vy = (e, t, n) =>
    ...
    Cy = (e, t, n = !1) =>
      vy(t, n, (t, n) =>
        I.from(e.getByData(t, n)).orThunk(() => py(n, t).map(n => yy(e, n, t))),
      ),
    wy =
  ...
  const A_ = (e, t, n, o, r, s) => {
    ...
    rS = (e, t) => {
      const n = Y(
        (e => eS(e, t => e.schema.isBlock(xn(t)) || (e => Wn(e) > 1)(t)))(e),
        tS,
      )
      return de(n).bind(o => {
        const r = Pl.fromRangeStart(e.selection.getRng())
      ...
      if (!t && Sk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind(n => m_(h_(e, Pl.before(t)), n.left)),
            )
  ...
  const sT = (e, t) => Math.abs(e.left - t),
    ...
    DT = (e, t) => {
      const n = t.slice(),
        o = n.pop()
      return E(o)
        ? G(n, (e, t) => e.bind(e => I.from(e.childNodes[t])), I.some(e)).bind(
            e =>
    ...
    YO = (e, t) => {
      if (/^[0-9.]+$/.test(t)) {
        ...
        if (n >= 1 && n <= 7) {
          const o = (e => an.explode(e.options.get("font_size_style_values")))(
              e,
            ),
