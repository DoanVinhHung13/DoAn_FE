...
type Bookmark =
  StringPathBookmark | RangeBookmark | IdBookmark | IndexBookmark | PathBookmark
...
declare class EventDispatcher<T extends {}> {
  ...
  on<K extends string>(
    name: K,
    callback:
      false | ((event: EditorEvent<MappedEvent<T, K>>) => void | boolean),
    prepend?: boolean,
    extra?: {},
  ): this
...
type ContextMenuContents =
  string | ContextMenuItem | SeparatorMenuItemSpec | ContextSubMenu
...
type FancyMenuItemSpec =
  InsertTableMenuItemSpec | ColorSwatchMenuItemSpec | ImageSelectMenuItemSpec
...
type ToolbarSplitButtonItemTypes =
  ChoiceMenuItemSpec | SeparatorMenuItemSpec | ImageMenuItemSpec
...
type AutocompleterContents =
  SeparatorItemSpec | AutocompleterItemSpec | CardMenuItemSpec
...
type ContextFormSpec =
  ContextInputFormSpec | ContextSliderFormSpec | ContextSizeInputFormSpec
...
type ViewButtonSpec =
  ViewNormalButtonSpec | ViewToggleButtonSpec | ViewButtonsGroupSpec
...
type RemoveFormat =
  RemoveBlockFormat | RemoveInlineFormat | RemoveSelectorFormat
...
type InstanceApi<T extends DialogData> =
  UrlDialogInstanceApi | DialogInstanceApi<T>
...
type AllowedFormat =
  Separator | FormatReference | StyleFormat | NestedFormatting
interface Separator {
  title: string
}
...
type Primitive =
  string | number | boolean | Record<string | number, any> | Function
